...
```
The _total precipitation of 2018_ is `r sum(pull(water_18data, tl_precip))`.

The _total observations_ is `r count(water_total_data)`.

The number of _2017 and 2018 precipitation data_ is `r count(comb_data)`.

The _key variables_ in the total dataset is `r names(water_total_data)`.
